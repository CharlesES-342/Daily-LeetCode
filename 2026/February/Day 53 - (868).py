...
# adjacent if there are only 0's separating them (possibly no 0's). The distance between two 1's'
# 'is the absolute difference between their bit positions. For example, the two 1's in "1001"
